...
<head>
    ...
    @if (!config('adminlte.enabled_laravel_mix'))
        ...
        <link rel="stylesheet" href="{{ asset('vendor/adminlte/dist/css/fixedHeader.dataTables.min.css') }}">
        <link rel="stylesheet" href="{{ asset('vendor/adminlte/dist/css/responsive.bootstrap4.min.css') }}">
